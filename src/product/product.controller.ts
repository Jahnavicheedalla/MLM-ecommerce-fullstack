...
// Reuse the same Multer configuration as the service for consistent storage
const uploadMulterConfig = new FileUploadService().getMulterConfig();
...
export class ProductController {
    ...
    schema: {
      ...
      properties: {
        ...
        photo: {
          ...
          format: 'binary',
          description:
            'Product photo (max 10MB, formats: png, jpeg, jpg, gif, webp)',
        },
      },
  ...
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @UseInterceptors(FileInterceptor('photo', uploadMulterConfig))
